...
This page documents specific deviations from the OData v4 standard observed in FileMaker Server (FMS) and the internal workarounds implemented by `fm-odata-js` to ensure consistent behavior.
...
| Feature | Standard OData | FileMaker Server | `fm-odata-js` Implementation |
| :--- | :--- | :--- | :--- |
